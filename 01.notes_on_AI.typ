...
#mcpp_slide(title: "Preface", number: "1/2")[
...
#mcpp_slide(title: "Preface", number: "2/2")[
  ...
  _These notes are a living document and will be kept updated with new research findings and community contributions._ Check the latest version here #mcpp_link("https://github.com/federico-busato/Modern-CPP-Programming", "Modern-CPP-Programming")
]
...
#mcpp_slide(title: "Introduction", number: "1/3")[
  ...
  #mcpp_footnote[
    #mcpp_link(
      ...
      reference: "Tomlinson et al, Microsoft Research, 2025",
    )].

  #v(-20pt)
  #mcpp_quote_small(title: "AI tutoring outperforms in-class active learning", details: "Nature, 2025")[
    ...
    #mcpp_footnote[#mcpp_link(
      "https://www.nature.com/articles/s41598-025-97652-6",
      "AI tutoring outperforms in-class active learning: an RCT introducing a novel research-based design in an authentic educational setting",
      reference: "Kestin et al., Nature, Scientific Reports, 2025",
    )]
  ]
]
...
#mcpp_slide(title: "Introduction", number: "2/3")[
  ...
  #v(20pt)
  One of the most recurring topics is the comparison between biological and artificial intelligence. Often, we superficially attribute human-like characteristics to AI systems, anthropomorphizing LLMs and chatbots, and even suggesting human-AI intimacy.
  #mcpp_footnote_link(
...
#mcpp_slide(title: "Introduction", number: "3/3")[
...
#mcpp_slide(title: "AI and Human Brain are Structurally Different", number: "2/6")[
...
#mcpp_slide(title: "AI and Human Brain are Structurally Different", number: "3/6")[
  ...
  - #bold[The human brain is incredibly energy efficient]. It operates on about 20 watts of power. A recent study estimates biological computing is #mcpp_underline[\~ 1 billion times more efficient] than its AI counterpart.
    #mcpp_footnote_link(
...
#mcpp_slide(title: "AI and Human Brain are Structurally Different", number: "4/6")[

  #set list(spacing: 60pt)
  - #bold[The human brain is subject to continuous learning]. It performs inference and learning #mcpp_underline[concurrently], in #mcpp_underline[real time].
...
#mcpp_slide(title: "AI and Human Brain are Structurally Different", number: "5/6")[
  #v(-15pt)
...
#mcpp_slide(title: "AI and Human Brain are Structurally Different", number: "6/6")[
...
#mcpp_slide(title: "AI and Human Brain are Functionally Different", number: "1/6")[

  - Current AI models are #bold["stochastic parrots"]. #mcpp_footnote_link(
    ...
    #mcpp_quote_small(
      ...
      #indent() ... We don't know how to infuse machines with knowledge beyond feeding it a set of facts.\"  #mcpp_footnote_link(
...
#mcpp_slide(title: "AI and Human Brain are Functionally Different", number: "2/6")[
...
#mcpp_slide(title: "AI and Human Brain are Functionally Different", number: "3/6")[
...
#mcpp_slide(title: "AI and Human Brain are Functionally Different", number: "4/6")[
...
#mcpp_slide(title: "AI and Human Brain are Functionally Different", number: "6/6")[
...
#mcpp_slide(title: "The Illusion of Consciousness")[
  #set text(size: 19pt)
...
#mcpp_slide(title: "Final Remarks")[

  #mcpp_quote_small(title: "The Mythology Of Conscious AI", details: [\ Noema Magazine, 2026])[
...
#mcpp_slide(title: "Productivity Gain Uncertainty")[
...
#mcpp_slide(title: "Productivity Gain Uncertainty - No Benefits", number: "1/4")[

  #mcpp_quote_small(title: "The AI productivity boom is not here (yet)", details: [\ The Economist, 2026])[
...
#mcpp_slide(title: "Productivity Gain Uncertainty - No Benefits", number: "2/4")[
  ...
  #mcpp_quote_small(title: "Measuring the Impact of Early-2025 AI", details: [\ METR, 2025])[
...
#mcpp_slide(title: "Productivity Gain Uncertainty - No Benefits", number: "3/4")[

  #mcpp_quote_small(title: "PwC 2026 Global CEO Survey", details: [\ (4,454 executives in 95 countries)])[
...
#mcpp_slide(title: "Productivity Gain Uncertainty - No Benefits", number: "4/4")[
...
#mcpp_slide(title: "Productivity Gain Uncertainty - Mixed Benefits", number: "1/2")[

  #mcpp_quote_small(title: "AI Doesn't Reduce Work-It Intensifies It", details: [\ Harvard Business Review])[
    "AI tools didn't reduce work, they #bold[consistently intensified it].

    #indent() ... We identified three main forms of intensification: #mcpp_underline[task expansion], #mcpp_underline[blurred boundaries between work and non-work], and more #mcpp_underline[multitasking].
...
#mcpp_slide(title: "Productivity Gain Uncertainty - Mixed Benefits", number: "2/2")[

  #set text(size: 19pt)
  #mcpp_quote_small(title: "2026 State of the Workplace", details: [\ ActivTrak, 2026])[
...
#mcpp_slide(title: "Productivity Gain Uncertainty - Increased by AI", number: "1/2")[

  #align(center)[
    #image("notes_on_AI/smothering_heights.png", height: 83%)
  ]
  #mcpp_unmarked_footnote_link(
...
#mcpp_slide(title: "Productivity Gain Uncertainty - Increased by AI", number: "2/2")[
...
#mcpp_slide(title: "Productivity Gain and Labor Markets")[

  #mcpp_quote_small(title: "AI raises the productivity bar", details: [\ Science, 2026])[
    ...
    #indent() ... By making execution cheap, AI shifts value upstream toward cognitive tasks-judgment, problem framing, and integration--that are #mcpp_underline[unevenly distributed] and #mcpp_underline[slow to acquire]. As a result, access to AI alone is unlikely to equalize outcomes. #bold[What matters is not whether workers can use AI but whether they can turn its output into useful work.]"
    #mcpp_unmarked_footnote_link(
...
#mcpp_slide(title: "Unlikely Exponential Growth", number: "1/4")[

  #set list(spacing: 35pt)
  - #bold[Fundamental Physical Limits of Transistors and Memory].

    #set list(spacing: 25pt)
    - The thermodynamic minimum gate length of a _transistor_ will likely be reached by 2030, while the limits of photolithography are expected around 2029. #mcpp_footnote_link(
        "https://asteriskmag.com/issues/03/the-transistor-cliff",
        "The Transistor Cliff",
        "S. Constantin, 2023",
      )

    - _Memory bandwidth_ has been increasing far slower than FLOP/s, at 30x in the last 20 years (1.5x/2yr), while FLOP/s have increased 90,000x in the same period (3x/2yr). This is a much more conservative constraint on potential AI growth. #mcpp_footnote_link(
        "https://ieeexplore.ieee.org/document/10477550",
        "AI and Memory Wall",
        "Gholami et al., IEEE Micro, 2024",
      )#super(",") #mcpp_footnote_link(
...
#mcpp_slide(title: "Unlikely Exponential Growth", number: "2/4")[

  #set list(spacing: 40pt)
  - #bold[Hardware Resource Constraints]. Reconstructing one cubic millimeter of human temporal cortex (\~50-57k cells and \~130-150M synapses) generated 1.4 Petabytes of data. Scaling to the full human brain would require 1.6 zettabytes of storage costing \$50 billion and spanning 140 acres. #mcpp_footnote_link(
  ...
  - #bold[Datacenters require 24/7 energy]. Solar and wind energy are not suitable for this purpose. On average, a nuclear power plant takes about #mcpp_underline[9.4 years] to build, with an additional #mcpp_underline[3-4 years] for the licensing process. #mcpp_footnote_link(
...
#mcpp_slide(title: "Unlikely Exponential Growth", number: "3/4")[
...
#mcpp_slide(title: "Unlikely Exponential Growth", number: "4/4")[

  #set list(spacing: 40pt)
  - #bold[Run out of data]. AI training will exhaust its data by 2027, or by 2032 if the rate of computing growth slows down. #mcpp_footnote_link(
  ...
  - #bold[AI quality degradation when trained on recursively generated data]. AI-generated content has surpassed the _quantity_ of human-written articles. This implies that AI models are trained on increasingly lower-quality data, reinforcing hallucinations.
    #mcpp_footnote_link(
...
#mcpp_slide(title: "Hallucinations are Mathematically Inevitable", number: "1/3")[

  #mcpp_quote_small(title: "AI hallucinations are mathematically inevitable", details: [\ OpenAI, GeorgiaTech, 2025])[
...
#mcpp_slide(title: "Hallucinations are Mathematically Inevitable", number: "2/3")[

  #mcpp_quote_small(title: "GPTZero")[
...
#mcpp_slide(title: "Hallucinations are Mathematically Inevitable", number: "3/3")[

  #mcpp_quote_small(title: "Deloitte goes all in on AI", details: [\ TechCrunch, 2025])[
  ...
  #v(-10pt)
  #mcpp_quote_small(title: "Wired, 2025")[
...
#mcpp_slide(title: "Generalization")[

  - #bold[Lack of generalization beyond the training data.]

  #mcpp_quote_small(title: "ARC Prize 2025", details: [\ Chollet et al., 2026])[
    "#bold[AI reasoning performance remains fundamentally constrained by knowledge coverage, a characteristic distinct from human reasoning which is capable of extreme generalization]. While this enables reliable automation of tasks with sufficient knowledge coverage and verifiable feedback signals, it also introduces new forms of #mcpp_underline[overfitting]."
    #mcpp_footnote_link(
...
#mcpp_slide(title: "Creativity", number: "1/2")[

  - #bold[Perceived AI creativity degrades into template-like recombination.]

  #mcpp_quote_small(title: "Echoes in AI", details: [\ PNAS, 2025])[
...
#mcpp_slide(title: "Creativity", number: "2/2")[
  ...
  #mcpp_quote_small(
    ...
    "#bold[Everything becomes homogenous, converging toward the average. The average makes nobody feel anything.]"
    #mcpp_footnote_link(
...
#mcpp_slide(title: "Production Quality", number: "1/2")[
...
#mcpp_slide(title: "Production Quality", number: "2/2")[
...
#mcpp_slide(title: "Causality and Real-World Understanding", number: "1/3")[
...
#mcpp_slide(title: "Causality and Real-World Understanding", number: "2/3")[
...
#mcpp_slide(title: "Causality and Real-World Understanding", number: "3/3")[

  #mcpp_quote_small(title: "Gemini for Google Cloud and responsible AI", details: [\ Google, 2026])[
...
#mcpp_slide(title: "Non-Determinism")[

  #set list(spacing: 50pt)
  - #bold[Almost all AI models are non-deterministic]. The same model with identical inputs could produce very different results. Non-determinism undermines #mcpp_underline[reliability] and #mcpp_underline[reproducibility], and creates #mcpp_underline[inconsistent] user experiences.

  #mcpp_quote_small(title: "Defeating Nondeterminism in LLM Inference", details: [\ ThinkingMachines, 2025])[
...
#mcpp_slide(title: "Quality Degradation")[

  - #bold[The same AI model can significantly degrade over time]. Such behavior can manifest over the course of months or even days #mcpp_footnote_link("https://marginlab.ai/trackers/claude-code/", "Claude Code Opus 4.5 Performance Tracker", "MarginLab").

  #v(-14pt)
  #mcpp_quote_small(title: "How Is ChatGPT's Behavior Changing Over Time?", details: "MIT Press, 2024")[
    ...
    #mcpp_footnote_link("https://hdsr.mitpress.mit.edu/pub/y95zitmz/release/2", "How Is ChatGPT's Behavior Changing Over Time?", "Chen et al., MIT Press, 2024").
  ]
]
...
#mcpp_slide(title: "Intellectual Property", number: "1/2")[

  - #bold[Private Code Violation]. LLM can memorize unique snippets of code from private sources and use them without any transparency.
  ...
  #mcpp_quote_small(title: "The skeptic's guide to generative AI assisted coding", details: [\ Rob Patro, 2026])[
...
#mcpp_slide(title: "Intellectual Property", number: "2/2")[

  #mcpp_quote_small(title: "Extracting books from production language models", details: [\ Ahmed et al., 2026])[
...
#mcpp_slide(title: "Sycophancy", number: "1/3")[
...
#mcpp_slide(title: "Sycophancy", number: "2/3")[
...
#mcpp_slide(title: "Sycophancy", number: "3/3")[
...
#mcpp_slide(title: "Social Coherence")[

  - #bold[LLMs are not able to perform actions consistently considering the context,  others, agent itself, permissions, and consequences across interactions].
  #v(-10pt)
...
#mcpp_slide(title: "Security Risks", number: "1/2")[

  - #bold[LLMs can be maliciously used to inject commands.]
...
#mcpp_slide(title: "Security Risks", number: "2/2")[
...
#mcpp_slide(title: "Liability", number: "1/2")[
...
#mcpp_slide(title: "Liability", number: "2/2")[
  #set text(size: 19pt)

  #mcpp_quote_small(title: "Amazon service was taken down by AI coding bot", details: [\ Financial Times, 2026])[
...
= Implications for the Future <p3s>

// =====================================================================================================================

#mcpp_slide(title: "Implications for the Future")[
...
#mcpp_slide(title: "Employement", number: "1/2")[
...
#mcpp_slide(title: "Employement", number: "2/2")[
...
#mcpp_slide(title: "Deskilling", number: "1/2")[

  - #bold[AI has demonstrated significant user deskilling].
    #v(-10pt)
    #mcpp_quote_small(title: "How AI Impacts Skill Formation", details: "Anthropic, 2026")[
    ...
    #mcpp_quote_small(title: "Rapid generative AI rollout in health care", details: "The Lancet, 2025")[
...
#mcpp_slide(title: "Deskilling", number: "2/2")[

  #mcpp_quote_small(title: "Your Brain on ChatGPT", details: [\ Kosmyna et al., 2025])[
...
#mcpp_slide(title: "Echo Camber (Sycophancy Again)")[

  #mcpp_quote_small(title: "A Rational Analysis of the Effects of Sycophantic AI", details: [\ Batista et al., 2026])[
...
#mcpp_slide(title: "Social Risks", number: "1/2")[
  ...
  #v(-10pt)
  #mcpp_quote_small(title: "How malicious AI swarms can threaten democracy", details: [\ Science, 2026])[
...
#mcpp_slide(title: "Social Risks", number: "2/2")[

  #v(-5pt)
  #mcpp_quote_small(title: "On the conversational persuasiveness of GPT-4", details: "Nature, 2025")[
