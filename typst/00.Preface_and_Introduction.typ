...
#notes_slide(title: "Preface", number: "1/2")[
  I started writing these notes because I keep reading recurring misleading information, without any evidence, about the impact of AI on software development. #bold[I find this narrative harmful and unfair, especially for students or people early in their careers].
...
#notes_slide(title: "Preface", number: "2/2")[
  ...
  To maintain focus on the main topics and avoid digressions, I chose to leave out long descriptions and directly report data, research findings, anecdotal facts, and emblematic quotes from people with much more expertise than I do. This helps make the content succinct, avoid wasting your time, and (hopefully) keep it appealing.
  #v(20pt)
...
#notes_slide(title: "Introduction", number: "2/2")[
  ...
  In the following slides, we disentangle the most common misconceptions related to AI, the role of human expertise, and the tendency to attribute human traits to Large Language Models (LLMs). Contrary to _sensationalist_ statements based on "personal feelings", which are very common on social media, the following analysis is grounded in recent research data. A brief summary:
  ...
  - Impact of AI on software development, covering software employment, the role of software engineering, and the risks of AI-generated code.
]

// =====================================================================================================================

#notes_slide(title: "Legend")[

  The slides are tagged with a specific icon to help you quickly identify the type of content.

  #v(20pt)
  #science-tag(): Scientific article or research.

  #v(20pt)
  #news-tag(): News article or report.

  #v(20pt)
  #comment-tag(): Author's comments.
]
